...
/**
 * this class is used to test file reader.
...
public class FileReaderTesting {
    ...
    public static void main (String[] args){
        ...
        ArrayList<User> users = new ArrayList<>(); //arraylist containing users
        ArrayList<Bid> bids = new ArrayList<>(); //arraylist containing bids
        ArrayList<Sculpture> sculptures = new ArrayList<>(); //arraylist containing sculptures
        ArrayList<Painting> paintings = new ArrayList<>(); //arraylist containing paintings
